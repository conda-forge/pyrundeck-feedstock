...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrundeck-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11621&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrundeck-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrundeck` can be installed with:

```
conda install pyrundeck
```

It is possible to list all of the versions of `pyrundeck` available on your platform with:
